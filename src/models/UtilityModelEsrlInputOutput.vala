...
class UtilityModelEsrlInputOutput {
    ...
    public static RunTimeData getRunTime(ObjectModel om) {
        ...
        var monthStr1 = UtilityTime.monthWordToNumber(UtilityString.parse(html, pattern6));
        ...
        if (html != "") {
            foreach (var data in UtilityList.range3(0, 12, 1)) {
                ...
                var monthStr = UtilityTime.monthWordToNumber(UtilityString.parse(oldRunTimes[data], pattern6));
