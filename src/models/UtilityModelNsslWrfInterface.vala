...
class UtilityModelNsslWrfInterface {
    ...
    public const string[] paramsNsslWrf = {
        "mslp",
        "10mwind",
        "sfct",
        "sfctd",
    ...
    public const string[] labelsNsslWrf = {
        "MSLP (mb)",
        "10 m Wind (kt)",
        "2-m Temperature",
        "2-m Dew Point",
    ...
    public const string[] paramsNsslFv3 = {
        "mslp",
        "10mwind",
        "sfct",
        "sfctd",
    ...
    public const string[] labelsNsslFv3 = {
        "MSLP (mb)",
        "10 m Wind (kt)",
        "2-m Temperature",
        "2-m Dew Point",
    ...
    public const string[] paramsNsslHrrrv3 = {
        "mslp",
        "10mwind",
        "sfct",
        "sfctd",
    ...
    public const string[] labelsNsslHrrrv3 = {
        "MSLP (mb)",
        "10 m Wind (kt)",
        "2-m Temperature",
        "2-m Dew Point",
    ...
    public const string[] sectorsLong = {
        "CONUS",
        "Central Plains",
        "Mid Atlantic",
        "Midwest",
