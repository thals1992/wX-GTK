...
class NhcStormDetails {
    ...
    public NhcStormDetails(string name, string movementDir, string movementSpeed, string pressure, string binNumber, string stormId, string lastUpdate, string classification, string lat, string lon, string intensity, string status) {
        this.name = name;
