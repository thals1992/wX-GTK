...
public class RadarBuffers {
    ...
    public void setBackgroundColor() {
        ColorPalette.colorMap[productCode].redValues.putByIndex(0, Color.red(RadarPreferences.nexradRadarBackgroundColor));
        ColorPalette.colorMap[productCode].greenValues.putByIndex(0, Color.green(RadarPreferences.nexradRadarBackgroundColor));
        ColorPalette.colorMap[productCode].blueValues.putByIndex(0, Color.blue(RadarPreferences.nexradRadarBackgroundColor));
    }

    public void putColorsByIndex(uint8 level) {
        putColor(ColorPalette.colorMap[productCode].redValues.getByIndex(level));
        putColor(ColorPalette.colorMap[productCode].greenValues.getByIndex(level));
        putColor(ColorPalette.colorMap[productCode].blueValues.getByIndex(level));
    }
}
