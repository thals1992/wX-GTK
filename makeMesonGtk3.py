#!/usr/bin/env python3
#
# generate meson.build when using gtk3
...
targetFile: str = "meson.build"
header: str = """project('wxgtk', ['c', 'vala'])

vapi_dir = meson.current_source_dir() / 'src/vapi'
add_project_arguments(['--vapidir', vapi_dir, '-D', 'GTK3'], language: 'vala')
# add_project_arguments(['-D', 'GTK3'], language: 'vala')
...
executable('wxgtk', wx_src, install: true,
